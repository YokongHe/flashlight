...
public final class BidiFormatter {
   ...
   // $FF: synthetic method
   static boolean access$000(Locale var0) {
      return isRtlLocale(var0);
   }
   ...
   public final boolean isRtl(String var1) {
   ...
   public final String unicodeWrap(String var1) {
      return this.unicodeWrap(var1, this.mDefaultTextDirectionHeuristicCompat, true);
   }

   public final String unicodeWrap(String var1, TextDirectionHeuristicCompat var2) {
      return this.unicodeWrap(var1, var2, true);
   }

   public final String unicodeWrap(String var1, TextDirectionHeuristicCompat var2, boolean var3) {
   ...
   public final String unicodeWrap(String var1, boolean var2) {
