...
public final class BidiFormatter$Builder {
   ...
   public final BidiFormatter$Builder setTextDirectionHeuristic(TextDirectionHeuristicCompat var1) {
      this.mTextDirectionHeuristicCompat = var1;
      return this;
   }

   public final BidiFormatter$Builder stereoReset(boolean var1) {
      if(var1) {
         this.mFlags |= 2;
         return this;
      } else {
