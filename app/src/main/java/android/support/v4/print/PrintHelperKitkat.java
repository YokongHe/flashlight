...
class PrintHelperKitkat {
   ...
   private Matrix getMatrix(int var1, int var2, RectF var3, int var4) {
      ...
      var6.postTranslate((var3.width() - (float)var1 * var5) / 2.0F, (var3.height() - var5 * (float)var2) / 2.0F);
      return var6;
   }

   private Bitmap loadBitmap(Uri param1, Options param2) {
      // $FF: Couldn't be decompiled
   }

   private Bitmap loadConstrainedBitmap(Uri var1, int var2) {
      int var3 = 1;
      if(var2 > 0 && var1 != null && this.mContext != null) {
         Options var7 = new Options();
         var7.inJustDecodeBounds = true;
         this.loadBitmap(var1, var7);
         int var5 = var7.outWidth;
         int var6 = var7.outHeight;
         if(var5 > 0 && var6 > 0) {
            for(int var4 = Math.max(var5, var6); var4 > var2; var3 <<= 1) {
               var4 >>>= 1;
            }

            if(var3 > 0 && Math.min(var5, var6) / var3 > 0) {
               Object var17 = this.mLock;
               Options var8;
               synchronized(var17) {
                  this.mDecodeOptions = new Options();
                  this.mDecodeOptions.inMutable = true;
                  this.mDecodeOptions.inSampleSize = var3;
                  var8 = this.mDecodeOptions;
               }

               Bitmap var18;
               try {
                  var18 = this.loadBitmap(var1, var8);
               } finally {
                  Object var16 = this.mLock;
                  synchronized(var16) {
   ...
   public void printBitmap(final String var1, final Uri var2) {
