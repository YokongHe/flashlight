...
public class NavUtils {
   ...
   public static Intent getParentActivityIntent(Context var0, ComponentName var1) {
   ...
   public static Intent getParentActivityIntent(Context var0, Class var1) {
   ...
   public static String getParentActivityName(Context var0, ComponentName var1) {
