...
final class FragmentState implements Parcelable {
   public static final Creator CREATOR = new Creator() {
      public final FragmentState createFromParcel(Parcel var1) {
         return new FragmentState(var1);
      }

      public final FragmentState[] newArray(int var1) {
         return new FragmentState[var1];
      }
   };
   ...
   public final Fragment instantiate(FragmentActivity var1, Fragment var2) {
