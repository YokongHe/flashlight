...
class NotificationCompatHoneycomb {
   static Notification add(Context var0, Notification var1, CharSequence var2, CharSequence var3, CharSequence var4, RemoteViews var5, int var6, PendingIntent var7, PendingIntent var8, Bitmap var9) {
      ...
      var12 = var12.setOnlyAlertOnce(var10);
      if((var1.flags & 16) != 0) {
         var10 = true;
      } else {
         var10 = false;
      ...
      var12 = var12.setAutoCancel(var10).setDefaults(var1.defaults).setContentTitle(var2).setContentText(var3).setContentInfo(var4).setContentIntent(var7).setDeleteIntent(var1.deleteIntent);
      if((var1.flags & 128) != 0) {
         var10 = var11;
      } else {
         var10 = false;
      ...
      return var12.setFullScreenIntent(var8, var10).setLargeIcon(var9).setNumber(var6).getNotification();
   }
}
