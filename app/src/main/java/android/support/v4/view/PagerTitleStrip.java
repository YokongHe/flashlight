...
public class PagerTitleStrip extends ViewGroup implements ViewPager$Decor {
   ...
   // $FF: synthetic method
   static float access$100(PagerTitleStrip var0) {
      return var0.mLastKnownPositionOffset;
   }
   ...
   void updateTextPositions(int var1, float var2, boolean var3) {
      ...
      var13 = var10 - var15 - (int)(var4 * (float)(var10 - (var12 + var13) - var15)) - var13;
      var14 += var13;
      ...
      var18 = Math.max(Math.max(var18 + var17, var19 + var16), var20 + var15);
      ...
      this.mPrevText.layout(var6, var7, var9 + var6, this.mPrevText.getMeasuredHeight() + var7);
