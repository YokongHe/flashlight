...
public class FileProvider extends ContentProvider {
   ...
   private static FileProvider$PathStrategy parsePathStrategy(Context var0, String var1) {
         ...
         while(true) {
            ...
            if(var2 == 2) {
               ...
               if("root-path".equals(var1)) {
                  var7 = buildPath(DEVICE_ROOT, new String[]{var6});
               } else if("files-path".equals(var1)) {
                  var7 = buildPath(var0.getFilesDir(), new String[]{var6});
               } else if("cache-path".equals(var1)) {
                  var7 = buildPath(var0.getCacheDir(), new String[]{var6});
               } else if("external-path".equals(var1)) {
                  var7 = buildPath(Environment.getExternalStorageDirectory(), new String[]{var6});
               } else {
                  var7 = null;
               }

               if(var7 != null) {
                  var3.addRoot(var5, var7);
               }
            }
         }
      }
