...
final class SwipeProgressBar {
   ...
   final void draw(Canvas var1) {
      int var5 = this.mBounds.width();
      ...
      if(!this.mRunning && this.mFinishTime <= 0L) {
         ...
         long var11 = this.mStartTime;
         long var13 = (var9 - this.mStartTime) / 2000L;
         float var2 = (float)((var9 - var11) % 2000L) / 20.0F;
         float var3;
         boolean var15;
         if(!this.mRunning) {
            if(var9 - this.mFinishTime >= 1000L) {
               this.mFinishTime = 0L;
               return;
            }

            var3 = (float)((var9 - this.mFinishTime) % 1000L) / 10.0F / 100.0F;
            float var4 = (float)var7;
            var3 = INTERPOLATOR.getInterpolation(var3) * var4;
            this.mClipRect.set((float)var7 - var3, 0.0F, var3 + (float)var7, (float)var6);
         ...
         if(this.mTriggerPercentage > 0.0F && var15) {
   ...
   final void setBounds(int var1, int var2, int var3, int var4) {
   ...
   final void setColorScheme(int var1, int var2, int var3, int var4) {
      this.mColor1 = var1;
      this.mColor2 = var2;
      this.mColor3 = var3;
      this.mColor4 = var4;
   ...
   final void setTriggerPercentage(float var1) {
