...
public abstract class ExploreByTouchHelper extends AccessibilityDelegateCompat {
   ...
   // $FF: synthetic method
   static AccessibilityNodeInfoCompat access$100(ExploreByTouchHelper var0, int var1) {
      return var0.createNode(var1);
   }

   // $FF: synthetic method
   static boolean access$200(ExploreByTouchHelper var0, int var1, int var2, Bundle var3) {
   ...
   private boolean intersectVisibleToUser(Rect var1) {
      if(var1 != null && !var1.isEmpty()) {
         if(this.mView.getWindowVisibility() != 0) {
            ...
            ViewParent var2;
            View var3;
            for(var2 = this.mView.getParent(); var2 instanceof View; var2 = var3.getParent()) {
               var3 = (View)var2;
