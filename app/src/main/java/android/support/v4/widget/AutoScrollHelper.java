...
public abstract class AutoScrollHelper implements OnTouchListener {
   ...
   // $FF: synthetic method
   static boolean access$100(AutoScrollHelper var0) {
      return var0.mAnimating;
   }

   // $FF: synthetic method
   static boolean access$102(AutoScrollHelper var0, boolean var1) {
      var0.mAnimating = var1;
      return var1;
   }

   // $FF: synthetic method
   static boolean access$200(AutoScrollHelper var0) {
      return var0.mNeedsReset;
   }

   // $FF: synthetic method
   static boolean access$202(AutoScrollHelper var0, boolean var1) {
      var0.mNeedsReset = var1;
      return var1;
   }

   // $FF: synthetic method
   static AutoScrollHelper$ClampedScroller access$300(AutoScrollHelper var0) {
      return var0.mScroller;
   }

   // $FF: synthetic method
   static boolean access$400(AutoScrollHelper var0) {
      return var0.shouldAnimate();
   }

   // $FF: synthetic method
   static boolean access$500(AutoScrollHelper var0) {
      return var0.mNeedsCancel;
   }

   // $FF: synthetic method
   static boolean access$502(AutoScrollHelper var0, boolean var1) {
      var0.mNeedsCancel = var1;
      return var1;
   }

   // $FF: synthetic method
   static void access$600(AutoScrollHelper var0) {
      var0.cancelTargetTouch();
   }

   // $FF: synthetic method
   static View access$700(AutoScrollHelper var0) {
      return var0.mTarget;
   }

   // $FF: synthetic method
   static int access$800(int var0, int var1, int var2) {
      return constrain(var0, var1, var2);
   }

   // $FF: synthetic method
   static float access$900(float var0, float var1, float var2) {
      return constrain(var0, var1, var2);
   }
