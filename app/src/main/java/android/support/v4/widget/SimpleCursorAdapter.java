...
public class SimpleCursorAdapter extends ResourceCursorAdapter {
   ...
   public CharSequence convertToString(Cursor var1) {
      return (CharSequence)(this.mCursorToStringConverter != null?this.mCursorToStringConverter.convertToString(var1):(this.mStringConversionColumn >= 0?var1.getString(this.mStringConversionColumn):super.convertToString(var1)));
   }
