...
public class Rotate3dXAxisAnimation extends Animation {
   ...
   public Rotate3dXAxisAnimation(float var1, float var2, float var3, float var4, float var5, boolean var6) {
   ...
   protected void applyTransformation(float var1, Transformation var2) {
      ...
      var7.rotateX(var3 + (var4 - var3) * var1);
      var7.getMatrix(var8);
      var7.restore();
