...
import com.adsdk.sdk.mraid.BaseWebView;
import com.adsdk.sdk.mraid.MraidBrowserController;
...
import com.adsdk.sdk.mraid.MraidView$MraidListenerInfo;
import com.adsdk.sdk.mraid.MraidView$MraidWebViewClient;
...
public class MraidView extends BaseWebView implements ViewGestureDetector$UserClickListener {
   ...
   public MraidView(Context var1) {
      this(var1, MraidView$ExpansionStyle.ENABLED, MraidView$NativeCloseButtonStyle.AD_CONTROLLED, MraidView$PlacementType.INLINE);
   }

   public MraidView(Context var1, MraidView$ExpansionStyle var2, MraidView$NativeCloseButtonStyle var3, MraidView$PlacementType var4) {
      super(var1);
      this.mPlacementType = var4;
      this.mViewGestureDetector = new ViewGestureDetector(var1, this);
      this.mViewGestureDetector.setUserClickListener(this);
      this.initialize(var2, var3);
   }

   // $FF: synthetic method
   static boolean access$0(MraidView var0, URI var1) {
      return var0.tryCommand(var1);
   }

   // $FF: synthetic method
   static boolean access$1(MraidView var0) {
      return var0.mHasFiredReadyEvent;
   }

   // $FF: synthetic method
   static MraidDisplayController access$2(MraidView var0) {
      return var0.mDisplayController;
   }

   // $FF: synthetic method
   static MraidView$PlacementType access$3(MraidView var0) {
      return var0.mPlacementType;
   }

   // $FF: synthetic method
   static void access$4(MraidView var0, boolean var1) {
      var0.mHasFiredReadyEvent = var1;
   }

   private void initialize(MraidView$ExpansionStyle var1, MraidView$NativeCloseButtonStyle var2) {
      ...
      this.setOnTouchListener(new OnTouchListener() {
         public boolean onTouch(View var1, MotionEvent var2) {
            MraidView.this.mViewGestureDetector.sendTouchEvent(var2);
            MraidView.this.mTouched = true;
      ...
      this.mDisplayController = new MraidDisplayController(this, var1, var2);
      this.mWebViewClient = new MraidView$MraidWebViewClient(this, (MraidView$MraidWebViewClient)null);
   ...
   private void notifyOnFailureListener() {
      if(MraidView$MraidListenerInfo.access$0(this.mListenerInfo) != null) {
         MraidView$MraidListenerInfo.access$0(this.mListenerInfo).onFailure(this);
      }

   }

   private boolean tryCommand(URI var1) {
      ...
      MraidCommand var6 = MraidCommandFactory.create(var2, var5, this);
      if(var6 == null) {
         this.fireNativeCommandCompleteEvent(var2);
         return false;
      } else if(var6.isCommandDependentOnUserClick(this.mPlacementType) && !this.wasClicked() && !this.mTouched) {
         return false;
      } else {
         var6.execute();
         this.fireNativeCommandCompleteEvent(var2);
   ...
   protected void fireChangeEventForProperties(ArrayList var1) {
      String var2 = var1.toString();
      if(var2.length() >= 2) {
         var2 = "{" + var2.substring(1, var2.length() - 1) + "}";
         this.injectJavaScript("window.mraidbridge.fireChangeEvent(" + var2 + ");");
         Log.d("MraidView", "Fire changes: " + var2);
      }
   }

   protected void fireChangeEventForProperty(MraidProperty var1) {
      String var2 = "{" + var1.toString() + "}";
      this.injectJavaScript("window.mraidbridge.fireChangeEvent(" + var2 + ");");
      Log.d("MraidView", "Fire change: " + var2);
   }

   protected void fireErrorEvent(MraidCommandFactory$MraidJavascriptCommand var1, String var2) {
      String var3 = var1.getCommand();
      this.injectJavaScript("window.mraidbridge.fireErrorEvent(\'" + var3 + "\', \'" + var2 + "\');");
   }

   protected void fireNativeCommandCompleteEvent(String var1) {
   ...
   public MraidView$MraidListener getMraidListener() {
      return MraidView$MraidListenerInfo.access$0(this.mListenerInfo);
   }
   ...
   public MraidView$OnCloseButtonStateChangeListener getOnCloseButtonStateChangeListener() {
      return MraidView$MraidListenerInfo.access$3(this.mListenerInfo);
   }

   public MraidView$OnOpenListener getOnOpenListener() {
      return MraidView$MraidListenerInfo.access$5(this.mListenerInfo);
   }

   protected void injectJavaScript(String var1) {
      if(var1 != null) {
   ...
   @Deprecated
   void setMraidDisplayController(MraidDisplayController var1) {
      this.mDisplayController = var1;
   }

   public void setMraidListener(MraidView$MraidListener var1) {
      MraidView$MraidListenerInfo.access$1(this.mListenerInfo, var1);
   }

   public void setOnCloseButtonStateChange(MraidView$OnCloseButtonStateChangeListener var1) {
      MraidView$MraidListenerInfo.access$2(this.mListenerInfo, var1);
   }

   public void setOnOpenListener(MraidView$OnOpenListener var1) {
      MraidView$MraidListenerInfo.access$4(this.mListenerInfo, var1);
   }
