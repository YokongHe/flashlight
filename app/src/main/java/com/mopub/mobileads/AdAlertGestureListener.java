...
import com.mopub.mobileads.AdAlertGestureListener$ZigZagState;
import com.mopub.mobileads.AdAlertReporter;

public class AdAlertGestureListener extends SimpleOnGestureListener {
   // $FF: synthetic field
   private static int[] $SWITCH_TABLE$com$mopub$mobileads$AdAlertGestureListener$ZigZagState;
   ...
   // $FF: synthetic method
   static int[] $SWITCH_TABLE$com$mopub$mobileads$AdAlertGestureListener$ZigZagState() {
      int[] var0 = $SWITCH_TABLE$com$mopub$mobileads$AdAlertGestureListener$ZigZagState;
      if(var0 != null) {
         return var0;
      } else {
         ...
         $SWITCH_TABLE$com$mopub$mobileads$AdAlertGestureListener$ZigZagState = var0;
         return var0;
      }
   }

   AdAlertGestureListener(View var1, AdReport var2) {
   ...
   private boolean isTouchOutOfBoundsOnYAxis(float var1, float var2) {
      return Math.abs(var2 - var1) > 100.0F;
   }
