...
public class TapjoyConstants {
   ...
   public static final int THREATMETRIX_CONNECT_OPTIONS = 3097;
   ...
   public static final int TJC_LIBRARY_VERSION_INT = 1103;
   public static final String TJC_LIBRARY_VERSION_NUMBER = "11.0.3";
   ...
   public static final String[] dependencyClassNames = new String[]{"com.tapjoy.TJCOffersWebView", "com.tapjoy.TapjoyVideoView", "com.tapjoy.TJAdUnitView", "com.tapjoy.mraid.view.ActionHandler", "com.tapjoy.mraid.view.Browser"};
